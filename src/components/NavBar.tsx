            ...
            <Collapse in={isOpen} animateOpacity style={{ marginTop: '0!important' }}>
                <Stack
                    ...
                    {children &&
                        children.map((child) => (
                            <Link as={GatsbyLink}
                                key={child.label} py={2} to={child.href}>
                                {child.label}
                            </Link>
                        ))}
                </Stack>
...
const NAV_ITEMS: Array<NavItem> = [
    {
        ...
        children: [
            {
                label: 'Aktuelles',
                subLabel: 'Hier erfahren Sie alle neuen Infos',
                href: '/news',
            },
            {
                label: 'Archiv',
                subLabel: 'Etwas verpasst? Kein Problem: Lesen Sie alles in unserem Archiv nach',
                href: '/news',
            },
        ],
    },
    {
        ...
        children: [
            {
                label: 'Bildungsgänge',
                subLabel: 'Alle Bildungsgangsangebote der BBS Buchholz',
                href: '/news',
            },
            {
                label: 'Berufsorierentierung',
                subLabel: 'Nach unschlüssig? Erfahren Sie hier mehr über Ihre Möglichkeiten',
                href: '/news',
            },
        ],
    },
